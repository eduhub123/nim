        ...
        <div class="container">
            <div id="inner">
                <div class="management-box">
                    ...
                    <form method="post" enctype="multipart/form-data" id="addnew-service-form" novalidate>     
                    <ul class="management-form">
                        ...
                        <li class="col-4">
                            ...
                            <div class="nim-colorpicker">
                                <input type="text" id="service-color" name="color" class="form-control" value="#000000" required/>
                        ...
                        <li>
                            ...
                            <textarea id="service-description" name="description" class="form-control"></textarea>
                        </li>
                        <li>
