        ...
        <div class="container">
            <div id="inner">
                <div class="management-box">
                    ...
                    <form method="post" id="addnew-ad-form" novalidate>     
                    <ul class="management-form">
                        ...
                        <li>
                            ...
                            <select class="form-control" name="parent_id" id="service-parent_id">
                        ...
                        <li class="col-4">
                            ...
                            <div class="nim-colorpicker">
                                <input type="text" name="color" class="form-control" value="#000000" required/>
                                <span style="background-color: #000000"></span>
                            </div>
                        </li>
                        <li>
                            <label>Icon (Font Awesome)</label>
                            <input type="text" name="icon" class="form-control" placeholder="fa-something"/>
                        </li>
                        <li>
                            <label>AD Description</label>
                            <textarea id="ad-description" name="description" class="form-control"></textarea>
                        </li>
                        <li>
